									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="review-content-section">
											<div class="input-group mg-b-pro-edt">
												...
												<input type="text" value="<?= set_value('nama_diskon') ?>" name="nama_diskon" class="form-control" placeholder="Nama Diskon" />
											</div>
											...
											<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
												<input type="date" value="<?= set_value('tgl') ?>" name="tgl" class="form-control" placeholder="Tanggal Selesai" />
											</div>

					...
					<div class="review-tab-pro-inner">
						...
						<div id="myTabContent" class="tab-content custom-product-edit">
							<div class="product-tab-list tab-pane fade active in" id="description">
								...
								echo form_open_multipart('master_produk/edit_size/' . $size->id_size . '/' . $size->id_produk) ?>
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="review-content-section">
											<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
												<input type="text" class="form-control" name="size" value="<?= $size->size ?>" placeholder="Size Product">
											</div>
											<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
												<input type="text" class="form-control" name="warna" value="<?= $size->warna ?>" placeholder="Color Product">
											</div>
											<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
												<input type="number" name="harga" value="<?= $size->harga ?>" class="form-control" placeholder="Regular Price">
											</div>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="review-content-section">
											<div class="input-group mg-b-pro-edt">
												...
												<input type="number" class="form-control" name="stock" value="<?= $size->stock ?>" placeholder="Product Stock">
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="text-center custom-pro-edt-ds">
											...
											<a href="<?= base_url('master_produk/size_produk/' . $size->id_produk) ?>" class="btn btn-ctl-bt waves-effect waves-light">Kembali
											</a>
										</div>
									</div>
								</div>
